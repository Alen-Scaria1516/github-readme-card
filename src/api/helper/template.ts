...
export default function template(data: GetData): string {
//   let card = `<svg width="495" height="195" viewBox="0 0 495 195" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
//     <style>
//         .leftdiv {
...
//         .singleitem {
//             opacity: 0;res.status(500).send(error.message);
...
//         }
//     </style>
//     <rect x="0.5" y="0.5" rx="4.5" height="99%" width="494" fill="#fff" stroke="#7e7979" stroke-opacity="1" />
...
//                 xlink:href="data:image/png;base64,${data.profilePic}">
//             </image>
//         </pattern>
//     </defs>
//     <circle cx="86" cy="44" r="40" stroke="#fff" stroke-width="3" fill="url(#image)" />
...
//         <text x="114" y="124" style="font-weight: 700" class="followers">323</text>
...
//                     <text class="text" style="font-weight: 700" x="150" y="12.5">32</text>
//                 </g>
//             </g>
...
//                     <text class="text" style="font-weight: 700" x="150" y="12.5">42</text>
//                 </g>
//             </g>
...
//                     <text class="text" style="font-weight: 700" x="150" y="12.5">343</text>
//                 </g>
//             </g>
...
//                     <text class="text" style="font-weight: 700" x="150" y="12.5">53</text>
//                 </g>
//             </g>
...
//                     <text class="text" style="font-weight: 700" x="150" y="12.5">422</text>
//                 </g>
//             </g>
...
let card2 = `<svg width="495" height="195" viewBox="0 0 495 195" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<style>
    .leftdiv {
        animation: fadeH 0.7s ease-in-out forwards;
    }
...
<g transform="translate(0, 25)">
    <g class="leftdiv">
        <defs>
            <pattern id="image" x="0%" y="0%" height="100%" width="100%" viewBox="0 0 512 512">
                <image x="0%" y="0%" width="512" height="512" xlink:href="data:image/png;base64,${data.profilePic}"></image>
            </pattern>
        </defs>
        <text x="50%" y="10" class="namepl" text-anchor="middle">${data.name}'s Github stats</text>
        <circle cx="50%" cy="70" r="40" stroke="#fff" stroke-width="3" fill="url(#image)" />
        <text x="50%" y="130" class="followers" text-anchor="middle">Followers: ${data.followers}</text>
    </g>
</g>
</svg>`
